...
def render():
    ...
    with col2:
        ...
        st.markdown(feature_card(
            ...
            "Unified telemetry tracking progress metrics, budget utilization, material BOQ, and project health indicators."
        ), unsafe_allow_html=True)
        st.markdown("<br>", unsafe_allow_html=True)
        st.markdown(feature_card(
            "🧱", "Material Estimation", "BOQ Generation",
            "Automated material quantities, labour, equipment costs, waste allowance, and Bill of Quantities export."
        ), unsafe_allow_html=True)
